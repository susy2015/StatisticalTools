...
def main():
   ...
   parser.add_option("-e", "--extra", action="store", dest="extrafile", type="string", default="ori_combined_plots_T2tt/signal_strength.root", help="set root file name")
   ...
   parser.add_option("-c", "--cover", action="store", dest="cover", type="string", default="no", help="yes to cover the top corridor")
   ...
   if options.outputdir:
      ...
      elif "T1tttt" in options.rtfile:
         output_filename = options.outputdir + "/T1tttt_" + stripDirrtInput
      elif "T5ttcc" in options.rtfile:
         output_filename = options.outputdir + "/T5ttcc_" + stripDirrtInput
   else:
      if "T2tt" in options.rtfile:
         ...
         if options.cover == "yes":
            ...
            for iy in xrange(nYBins):
               ...
               for ix in xrange(nXBins):
                  ...
                  if xCen <= yCen+175+25 and xCen >= yCen+175-25 and xCen <= 287.5:
