...
int nXbins = 47, nYbins = 47;
double loX = 337.5, hiX = 1512.5;
...
int plot(int argc, char** argv)
{
   ...
   if( argc != 2 ){
      std::cout<<"\n################USAGE##########################"<<std::endl;
      std::cout<<  "#./plot_RA2 xxx                               #"<<std::endl;
...
// this would be for T1tttt
   if( topoStr == "T1tttt" ){
      nXbins = 47, nYbins = 47;
      loX = 337.5, hiX = 1512.5;
      loY = 37.5, hiY = 1212.5;
   }
...
//         int xBinLargery = 2;
         int xBinLargery = 1;
         if( topoStr == "T5ZZInc" ) xBinLargery = 0;
...
// smoothMethod : 0 --> the "k5a",  1 --> the "k3a",  2 --> C.A.'s method
         int smoothMethod = 2;
         bool dorebin = false;
//         if( topoStr == "T1qqqq" )  radiusToSmooth = 4;
//         if( topoStr == "T2qq" )  radiusToSmooth = 4 ;// 32 before
//         if( topoStr == "T5ZZInc" ) radiusToSmooth = 16;
//         if( topoStr == "T1bbbb" ) radiusToSmooth = 16;
//         if( topoStr == "T1tttt" ) radiusToSmooth = 4;
         ...
         plotTools[0]->Area(obsExclOneTimesxSecProspinoSmooth, Mzero, Mhalf, NLOObsxSecCL, false);
         if( dointerpolation ){
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(obsExclOneTimesxSecProspinoTest, Mzero, Mhalf, NLOObsxSecCL, xSecProspino, 1.0, doMyFill, xBinLargery, 0, obsExclOneTimesxSecProspinoSmooth);
         }
...
// Sys Error on obs limit
         ...
         plotTools[0]->Area(obsExclPlusSysErrxSecProspinoSmooth, Mzero, Mhalf, NLOObsxSecCL, false);
         if( dointerpolation ){
...
//            Smooth(obsExclPlusSysErrxSecProspinoSmooth, radiusToSmoothTH2);
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(obsExclPlusSysErrxSecProspinoTest, Mzero, Mhalf, NLOObsxSecCL, xSecProspino, 1.0, doMyFill, xBinLargery, 1, obsExclPlusSysErrxSecProspinoSmooth);
         }
...
//         if( topoStr == "T1bbbb" ){ obsExclPlusSysErrxSecProspino->RemovePoint(0); obsExclPlusSysErrxSecProspino->RemovePoint(0); }
         ...
         plotTools[0]->Area(obsExclMinusSysErrxSecProspinoSmooth, Mzero, Mhalf, NLOObsxSecCL, false);
         if( dointerpolation ){
...
//            Smooth(obsExclMinusSysErrxSecProspinoSmooth, radiusToSmoothTH2);
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(obsExclMinusSysErrxSecProspinoTest, Mzero, Mhalf, NLOObsxSecCL, xSecProspino, 1.0, doMyFill, xBinLargery, -1, obsExclMinusSysErrxSecProspinoSmooth);
         }
...
*/
   ...
   // Expected Limit in M0 - M1/2
         ...
         plotTools[0]->Area(expExclOneTimesxSecProspinoSmooth, Mzero, Mhalf, NLOExpxSecCL, false);
         if( dointerpolation ){
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(expExclOneTimesxSecProspinoTest, Mzero, Mhalf, NLOExpxSecCL, xSecProspino, 1.0, doMyFill, xBinLargery, 0, expExclOneTimesxSecProspinoSmooth);
         }
...
//         Smooth(expExclOneTimesxSecProspinoTest);
...
// +1 Sigma
         ...
         plotTools[0]->Area(expExclPlusOneSigmaProspinoSmooth, Mzero, Mhalf, NLOExpxSecp1sigma, false);
         if( dointerpolation ){
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(expExclPlusOneSigmaProspinoTest, Mzero, Mhalf, NLOExpxSecp1sigma, xSecProspino, 1.0, doMyFill, xBinLargery, 0, expExclPlusOneSigmaProspinoSmooth);
         }
...
// -1 Sigma
         ...
         plotTools[0]->Area(expExclMinusOneSigmaProspinoSmooth, Mzero, Mhalf, NLOExpxSecm1sigma, false);
         if( dointerpolation ){
         ...
         if( !radiusToSmoothTH2 && !dorebin ){
            ...
            plotTools[0]->Area(expExclMinusOneSigmaProspinoTest, Mzero, Mhalf, NLOExpxSecm1sigma, xSecProspino, 1.0, doMyFill, xBinLargery, 0, expExclMinusOneSigmaProspinoSmooth);
         }
