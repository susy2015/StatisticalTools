...
import combCardPerChannel_noQCD_Rare_forSS as combCard
...
# Core function to produce the cards
         combCard.prodCardPerChn(tmp_signal_key, outputdir, lostle_file, hadtau_file, zinv_file, ttz_file, data_file, signal_file)
         signal_file.close()
