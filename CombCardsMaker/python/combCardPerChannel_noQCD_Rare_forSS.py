...
#   
   ...
   h1_data = rt.TH1D("data", "data", 45, 0, 45)
   h1_data.Sumw2()
   h1_lostle = rt.TH1D("lostle", "lostle", 45, 0, 45)
   h1_lostle.Sumw2()
   h1_hadtau = rt.TH1D("hadtau", "hadtau", 45, 0, 45)
   h1_hadtau.Sumw2()
   h1_zinv = rt.TH1D("zinv", "zinv", 45, 0, 45)
   h1_zinv.Sumw2()
   h1_qcd = rt.TH1D("qcd", "qcd", 45, 0, 45)
   h1_qcd.Sumw2()
   h1_ttz = rt.TH1D("ttz", "ttz", 45, 0, 45)
   h1_ttz.Sumw2()
   h1_rare = rt.TH1D("rare", "rare", 45, 0, 45)
   h1_rare.Sumw2()

   h1_lostle_syst = rt.TH1D("lostle_syst", "lostle_syst", 45, 0, 45)
   h1_lostle_syst.Sumw2()
   h1_hadtau_syst = rt.TH1D("hadtau_syst", "hadtau_syst", 45, 0, 45)
   h1_hadtau_syst.Sumw2()
   h1_zinv_syst = rt.TH1D("zinv_syst", "zinv_syst", 45, 0, 45)
   h1_zinv_syst.Sumw2()
   h1_qcd_syst = rt.TH1D("qcd_syst", "qcd_syst", 45, 0, 45)
   h1_qcd_syst.Sumw2()
   h1_ttz_syst = rt.TH1D("ttz_syst", "ttz_syst", 45, 0, 45)
   h1_ttz_syst.Sumw2()
   h1_rare_syst = rt.TH1D("rare_syst", "rare_syst", 45, 0, 45)
   h1_rare_syst.Sumw2()
...
# signal
      ...
      for signal_line in signal_file:
         ...
         if signal_splitline and signal_splitline[0] == "mistaggenTopSF_dn":
...
# hadtau
      ...
      if hadtau_syst_MCScale_pdf_trig_dn_rel == 1: hadtau_syst_MCScale_pdf_trig_dn_rel -= 0.001
      if hadtau_syst_closure_taumu_dn_rel == 1: hadtau_syst_closure_taumu_dn_rel -= 0.001
...
# zinv
      ...
      if zinv_syst_scale_pdf_trig_dn_rel == 1: zinv_syst_scale_pdf_trig_dn_rel -= 0.001
      if zinv_syst_norm_scale_pdf_trig_dn_rel == 1: zinv_norm_syst_scale_pdf_trig_dn_rel -= 0.001
      if zinv_syst_jeu_meu_dn_rel == 1: zinv_syst_jeu_meu_dn_rel -= 0.001

      if zinv_syst_norm_scale_pdf_trig_btag_bmistag_dn_rel ==1: zinv_syst_norm_scale_pdf_trig_btag_bmistag_dn_rel -= 0.001
